...
• Не размазывай context_weights: максимум две темы выше 0.5, остальные ≤0.2. Если тема вспомогательная — ставь не больше 0.2.
...
7. ✓ Context_weights нормализованы: не больше двух значений >0.5, остальные ≤0.2.
8. ✓ Повторяющийся паттерн добавлен заново для учёта частоты.
