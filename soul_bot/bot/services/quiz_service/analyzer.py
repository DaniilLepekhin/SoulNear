...
2. Для каждого паттерна опиши:
   ...
   • Противоречие: какие ответы конфликтуют и что это показывает (до 180 символов, лучше короче)
   • Скрытую динамику: какой страх/потребность управляет поведением (до 180 символов, лучше короче)
   • Заблокированный ресурс: какая сила уже есть, но направлена против себя, и как её перенаправить (до 160 символов, лучше короче)
   • Два точных цитирования из ответов (без переработки, каждое до 140 символов)
   • Уверенность (0.7–1.0)
...
4. ВАЖНО: Старайся укладываться в указанные лимиты символов, но завершай предложения полностью. Лучше чуть короче, чем обрывать мысль.
...
5. Длина одной рекомендации — до 150 символов (лучше короче), но обязательно завершай предложения полностью. Лучше одно полное предложение, чем два обрезанных.
