    ...
    <div className={`screen chat-screen ${isActive ? 'active' : ''}`} id="dreams-chat-screen">
      <div className="chat-header">
        <div className="chat-left-controls">
          <button className="chat-back-btn" onClick={() => setScreen('dreams')}>←</button>
      ...
      <div className="chat-messages" id="dreamsChatMessages"></div>
      <div className="chat-input-container">
        <button className="chat-voice-btn" onClick={() => setScreen('dreamsVoice')}>
        ...
        <input type="text" id="dreamsInput" placeholder="Расскажите о своём сне..." />
